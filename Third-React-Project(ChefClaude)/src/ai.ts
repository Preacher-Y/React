...
- ingredients: a list of ingredients with measurements(an array) incluing the one that didn't add in
- instructions: a list of instructions to make the recipe(an array)
- image: a URL to an image of the recipe and make sure the image url works
