...
import { useOpenSettingsContext } from "../hooks/openSettingsContext";
import clsx from "clsx";

export default function Settings() {
    const { isOpen } = useOpenContext();
    const { isOpenModel } = useOpenModelContext();
    const {isOpenSettings,setIsOpenSettings} = useOpenSettingsContext();
    ...
    return (
        <>
            ...
            >
                ...
                {!isOpenModel && isOpen && <span className="truncate">Settings & Help</span>}
            </button>
            {isOpenSettings && (
