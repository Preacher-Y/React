...
export default function AddFile(){
    ...
    return (
        <>
            <button className="hover:bg-gray-500/20 cursor-pointer flex items-center gap-1 rounded-full px-2 py-2">
            ...
            {isclicked && (<div className="absolute -top-10 left-3 w-52 bg-[#282A2C] backdrop-blur-md rounded-2xl shadow-lg py-2 transition-all duration-300 ease-in-out">
                <ul>
                    <li className="text-gray-300 hover:bg-gray-600/30 px-5 py-2 cursor-pointer flex gap-1 items-center">
