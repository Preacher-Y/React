      ...
      <div className='flex items-center justify-between gap-14 max-w-6xl mx-auto px-6'>
        ...
        <nav>
          ...
          <ul className="flex justify-center items-center space-x-6">
            ...
            {!isLoggedIn?(<li id='user' aria-label='user' className='flex'>
            ...
            </li>):(<li onClick={logOut} className='flex cursor-pointer gap-1 items-center text-sm group text-gray-600 hover:text-gray-900 hover:scale-105 transition-all duration-300'>
